...
const MyReservations = () => {
    ...
    const upcomingReservations = reservations.filter(res => isUpcoming(res.dateTime));
        ...
        <div className="min-h-screen w-full overflow-hidden bg-muted text-[#1F1B3B]">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                                            {upcomingReservations.map((reservation, index) => (
                                                ...
                                                >
                                                    ...
                                                    <button
                                                        onClick={() => handleCancelReservation(reservation.courtId, reservation.slotId)}
            ...
            {showSuccessToast && (
                <div className="fixed top-4 right-4 z-50 animate-slide-in">
                    <div className={`text-white px-6 py-4 rounded-lg shadow-lg flex items-center gap-3 min-w-[300px] ${toastMessage.includes("Failed") ? "bg-red-500" : "bg-orange-500"
                        }`}>
                        ...
                        <div className="flex-1">
                            <h4 className="font-semibold">
                                {toastMessage.includes("Failed") ? "Cancellation Failed" : "Cancellation Successful!"}
                            </h4>

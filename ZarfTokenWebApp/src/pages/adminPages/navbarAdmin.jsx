  ...
  >
    {isCollapsed ? <ChevronRight size={20} /> : <ChevronLeft size={20} />}
      ...
      <div className="flex-1 overflow-y-auto py-6 px-3 space-y-1 overflow-x-hidden custom-scrollbar">
        ...
        <NavLink to="/dashboard/admin/all-events" className={linkClass} title="All Events">
          <Calendar size={20} className="shrink-0" />
          {!isCollapsed && <span>All Events</span>}
        </NavLink>
        
        <NavLink to="/dashboard/admin/events-sales-report" className={linkClass} title="Sales Report">
          <LayoutDashboard size={20} className="shrink-0" />
          {!isCollapsed && <span>Sales Report</span>}
        </NavLink>
        
        <NavLink to="/dashboard/admin/event-attendees-report" className={linkClass} title="Attendees Report">
        ...
        <NavLink to="/dashboard/admin/signup-requests" className={linkClass} title="Sign-Up Requests">
          <Bell size={20} className="shrink-0" />
          {!isCollapsed && <span>Sign-Up Requests</span>}
        </NavLink>
        
        <NavLink to="/dashboard/admin/vendor-requests" className={linkClass} title="Vendor Requests">
        ...
        <NavLink to="/dashboard/admin/loyals" className={linkClass} title="Loyalty Partners">
          <Star size={20} className="shrink-0" />
          {!isCollapsed && <span>Loyalty Partners</span>}
        </NavLink>
        
        <NavLink to="/dashboard/admin/users" className={linkClass} title="User Management">
          <Users size={20} className="shrink-0" />
